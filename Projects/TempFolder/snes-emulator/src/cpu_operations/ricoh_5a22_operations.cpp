...
#define NATIVE_IMMEDIATE_M \
	...
	/* 2.2 */ MakeHandler(Ricoh5A22Functions::Read<ReadFrom::PCPB, ReadTo::Operand, Mode::ReadHigh>, Ricoh5A22Predicates::MFlagSet),
/*
...
#define NATIVE_DIRECT_INDEXED_INDIRECT_D_X_READ \
	...
	/* 5.2 */ MakeHandler(Ricoh5A22Functions::Read<ReadFrom::Address, ReadTo::Pointer, Mode::ReadHigh>), \
	...
	/* 7.2 */ MakeHandler(Ricoh5A22Functions::Read<ReadFrom::PointerDB, ReadTo::Operand, Mode::ReadHigh>, Ricoh5A22Predicates::MFlagSet),
...
#define NATIVE_STACK_RELATIVE_READ \
	...
	/* 4.2 */ MakeHandler(Ricoh5A22Functions::Read<ReadFrom::Address, ReadTo::Operand, Mode::ReadHigh>, Ricoh5A22Predicates::MFlagSet),
...
namespace Ricoh5A22Functions {
	...
	template <typename From, typename To, bool ReadHigh = false>
...
Instruction n_09 = {
	NATIVE_IMMEDIATE_M
	/* 3.1 */ MakeHandler(Ricoh5A22Functions::ORA<Mode::Native, Mode::PCIncrement>),
	NEXT_OPCODE
};
...
Instruction n_29 = {
	NATIVE_IMMEDIATE_M
	/* 3.1 */ MakeHandler(Ricoh5A22Functions::AND<Mode::Native, Mode::PCIncrement>),
	NEXT_OPCODE
};
...
Instruction n_49 = {
	NATIVE_IMMEDIATE_M
	/* 3.1 */ MakeHandler(Ricoh5A22Functions::EOR<Mode::Native, Mode::PCIncrement>),
	NEXT_OPCODE
};
...
Instruction n_69 = {
	NATIVE_IMMEDIATE_M
	/* 3.1 */ MakeHandler(Ricoh5A22Functions::ADC<Mode::Native, Mode::PCIncrement>),
	NEXT_OPCODE
};
